...
## ----bake off 2, message=TRUE, warning=TRUE, eval=FALSE-----------------------
#  
...
## ----call bake off, message=TRUE, warning=TRUE, eval=FALSE--------------------
#  out=modelcomparison(list.of.datasets = list.of.datasets)
#  
#  cake = bake.off(out)

## ----show paper plot bo, message=FALSE, warning=FALSE, eval=FALSE-------------
#  cake$p3

## ----models ranking split, eval=FALSE-----------------------------------------
#  # models ranking
#  
#  J=12
#  df<-data.frame(expand.grid(c(0:(J-1)),c(0:(J-1))),c(1:(J^2)))
...
## ----models ranking 3, eval=FALSE---------------------------------------------
#  full.ranks=modelsranking(list.of.datasets)

## ----ranking plot, eval=FALSE-------------------------------------------------
